...
export const GetPublicQuoteResponse = zod.object({
  ...
  "marketingHeadline": zod.string().nullable(),
  "marketingAbout": zod.string().nullable(),
  "marketingServices": zod.string().nullable(),
  "marketingDifferentials": zod.string().nullable(),
...
export const UpdateCompanyBody = zod.object({
  ...
  "marketingHeadline": zod.string().nullish(),
  "marketingAbout": zod.string().nullish(),
  "marketingServices": zod.string().nullish(),
  "marketingDifferentials": zod.string().nullish(),
