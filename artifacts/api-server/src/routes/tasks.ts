    ...
    GetPublicTaskFeedbackResponse.parse({
      ...
      company: team
        ? {
            ...
            legalName: team.legalName ?? null,
            taxId: team.taxId ?? null,
            website: team.website ?? null,
            pixKey: team.pixKey ?? null,
            bankDetails: team.bankDetails ?? null,
            paymentInstructions: team.paymentInstructions ?? null,
            additionalInfo: team.additionalInfo ?? null,
            marketingHeadline: team.marketingHeadline ?? null,
            marketingAbout: team.marketingAbout ?? null,
            marketingServices: team.marketingServices ?? null,
            marketingDifferentials: team.marketingDifferentials ?? null,
            showPhoneOnQuotes: team.showPhoneOnQuotes ?? true,
            showEmailOnQuotes: team.showEmailOnQuotes ?? true,
            showAddressOnQuotes: team.showAddressOnQuotes ?? true,
            showLegalNameOnQuotes: team.showLegalNameOnQuotes ?? false,
            showTaxIdOnQuotes: team.showTaxIdOnQuotes ?? false,
            showWebsiteOnQuotes: team.showWebsiteOnQuotes ?? false,
            showPixKeyOnQuotes: team.showPixKeyOnQuotes ?? false,
            showBankDetailsOnQuotes: team.showBankDetailsOnQuotes ?? false,
            showPaymentInstructionsOnQuotes: team.showPaymentInstructionsOnQuotes ?? false,
            showAdditionalInfoOnQuotes: team.showAdditionalInfoOnQuotes ?? false,
